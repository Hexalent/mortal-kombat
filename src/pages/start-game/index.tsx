...
export const StartGame = () => {
  ...
  return (
    <MotionPage className='relative flex h-screen min-h-screen flex-col items-center justify-center bg-[url(/public/background/start-game.jpg)] bg-cover bg-center bg-no-repeat'>
